package sg.edu.rp.webservices.p7sectionc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRetrieve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cursor cursor = cr.query(uri , reqCols,null,null,null,null);
                String smsBody = "";
                if(cursor.moveToFirst()){
                    do{
                        ...
                        String body = cursor.getString(2);        String type = cursor.getString(3);
